...
const Login: NextPage = () => {
  return (
    <>
      <main>
        <title>Login</title>
        <div className="m-auto p-10 max-w-md">
          <Image src='/images/poops-logo.jpg' width={40} height={40} layout="responsive" alt="POOPS logo"></Image>
        </div>

        <div className="font-bold text-xl text-center">Sign In</div>

        <div className="p-5 m-auto max-w-sm h-1/3 w-3/4 grid space-y-4">
